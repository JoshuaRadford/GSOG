...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static GameObject CreateWorldSprite(string name, UnityEngine.Sprite sprite, Vector3 position, Vector3 localScale, int sortingOrder, Color color) {
            return CreateWorldSprite(null, name, sprite, position, localScale, sortingOrder, color);
        }

        // Create a Sprite in the World
        public static GameObject CreateWorldSprite(Transform parent, string name, UnityEngine.Sprite sprite, Vector3 localPosition, Vector3 localScale, int sortingOrder, Color color) {
        ...
        public static Button_Sprite CreateWorldSpriteButton(string name, UnityEngine.Sprite sprite, Vector3 localPosition, Vector3 localScale, int sortingOrder, Color color) {
        ...
        public static Button_Sprite CreateWorldSpriteButton(Transform parent, string name, UnityEngine.Sprite sprite, Vector3 localPosition, Vector3 localScale, int sortingOrder, Color color) {
        ...
        public static TextMesh CreateWorldText(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, TextAnchor textAnchor, TextAlignment textAlignment, int sortingOrder) {
            ...
            textMesh.characterSize = textMesh.characterSize / 10;
        ...
        // Draw a UI Sprite
        public static RectTransform DrawSprite(UnityEngine.Sprite sprite, Transform parent, Vector2 pos, Vector2 size, string name = null) {
            RectTransform rectTransform = DrawSprite(sprite, Color.white, parent, pos, size, name);
            return rectTransform;
        }

        // Draw a UI Sprite
        public static RectTransform DrawSprite(UnityEngine.Sprite sprite, Color color, Transform parent, Vector2 pos, Vector2 size, string name = null) {
            // Setup icon
