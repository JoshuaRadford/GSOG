...
namespace CodeMonkey.Utils {
    ...
    public class World_Sprite {
        ...
        public static World_Sprite Create(Transform parent, Vector3 localPosition, Vector3 localScale, UnityEngine.Sprite sprite, Color color, int sortingOrderOffset) {
            return new World_Sprite(parent, localPosition, localScale, sprite, color, sortingOrderOffset);
        }
        public static World_Sprite Create(Vector3 worldPosition, UnityEngine.Sprite sprite) {
            return new World_Sprite(null, worldPosition, new Vector3(1, 1, 1), sprite, Color.white, 0);
        }
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, UnityEngine.Sprite sprite, Color color, int sortingOrderOffset) {
            return new World_Sprite(null, worldPosition, localScale, sprite, color, sortingOrderOffset);
        }
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, UnityEngine.Sprite sprite, Color color) {
        ...
        public World_Sprite(Transform parent, Vector3 localPosition, Vector3 localScale, UnityEngine.Sprite sprite, Color color, int sortingOrderOffset) {
